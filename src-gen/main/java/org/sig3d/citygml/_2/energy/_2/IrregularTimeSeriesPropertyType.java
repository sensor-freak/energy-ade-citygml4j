...
/**
 * <p>Java-Klasse für IrregularTimeSeriesPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}IrregularTimeSeries" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class IrregularTimeSeriesPropertyType {
    ...
    @XmlElementRef(name = "IrregularTimeSeries", namespace = "http://www.sig3d.org/citygml/2.0/energy/2.0", type = JAXBElement.class, required = false)
    protected JAXBElement<? extends IrregularTimeSeriesType> irregularTimeSeries;
    ...
    /**
     * Ruft den Wert der irregularTimeSeries-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public JAXBElement<? extends IrregularTimeSeriesType> getIrregularTimeSeries() {
        return irregularTimeSeries;
    }

    /**
     * Legt den Wert der irregularTimeSeries-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link MonthlyTimeSeriesType }{@code >}
     ...
     *     
     */
    public void setIrregularTimeSeries(JAXBElement<? extends IrregularTimeSeriesType> value) {
