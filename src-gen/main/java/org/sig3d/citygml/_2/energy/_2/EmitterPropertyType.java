...
/**
 * <p>Java-Klasse für EmitterPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}Emitter" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "EmitterPropertyType", propOrder = {
    "emitter"
})
public class EmitterPropertyType {

    @XmlElement(name = "Emitter")
    protected EmitterType emitter;
     ...
     *     
     */
    public void setEmitter(EmitterType value) {
        this.emitter = value;
    }

    public boolean isSetEmitter() {
