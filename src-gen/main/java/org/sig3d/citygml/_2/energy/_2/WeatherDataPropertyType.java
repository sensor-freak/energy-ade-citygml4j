...
/**
 * <p>Java-Klasse für WeatherDataPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}WeatherData" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "WeatherDataPropertyType", propOrder = {
    "weatherData"
})
public class WeatherDataPropertyType {
    ...
    /**
     * Ruft den Wert der weatherData-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der weatherData-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link WeatherDataType }
