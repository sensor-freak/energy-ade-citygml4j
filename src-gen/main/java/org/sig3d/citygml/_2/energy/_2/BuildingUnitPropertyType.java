...
/**
 * <p>Java-Klasse für BuildingUnitPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}BuildingUnit" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "BuildingUnitPropertyType", propOrder = {
    "buildingUnit"
})
public class BuildingUnitPropertyType {

    @XmlElement(name = "BuildingUnit")
    protected BuildingUnitType buildingUnit;
    ...
    /**
     * Ruft den Wert der buildingUnit-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link BuildingUnitType }
     *     
     */
    public BuildingUnitType getBuildingUnit() {
        return buildingUnit;
    }

    /**
     * Legt den Wert der buildingUnit-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link BuildingUnitType }
     *     
     */
    public void setBuildingUnit(BuildingUnitType value) {
