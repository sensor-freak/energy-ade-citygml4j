...
public enum ElevationReferenceValue {
    ...
    /**
     * The elevation has been captured at the bottom of the usable part of the construction. NOTE: The bottom of usable part of a building is generally its lowest underground floor.
     * 
     */
    ...
    /**
     * The elevation has been captured at eave level, anywhere between the lowest and the highest eave levels of the construction. NOTE: in case of a roof having a symmetry axis, values generalEave, lowestEave and highestEave are equivalent.
     * 
     */
    ...
    /**
     * The elevation has been captured at roof edge level, anywhere between the lowest and the highest roof edges of the construction. NOTE: in case of a roof having a symmetry axis, values generalRoofEdge, lowestRoofEdge and highestRoofEdge are equivalent.
     * 
     */
    ...
    /**
     * The elevation has been captured at the level of the lowest floor above ground. This value is of interest for over-hanging buildings or for buildings on pylons.
     * 
     */
    ...
    /**
     * The elevation has been captured at the top level of the construction. NOTE: for buildings, it is generally top of the roof.
     * 
     */
