...
/**
 * <p>Java-Klasse für EnergySourcePropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}EnergySource" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "EnergySourcePropertyType", propOrder = {
    "energySource"
})
public class EnergySourcePropertyType {

    @XmlElement(name = "EnergySource")
    protected EnergySourceType energySource;
     ...
     *     
     */
    public void setEnergySource(EnergySourceType value) {
        this.energySource = value;
    }

    public boolean isSetEnergySource() {
        return (this.energySource!= null);
    }
