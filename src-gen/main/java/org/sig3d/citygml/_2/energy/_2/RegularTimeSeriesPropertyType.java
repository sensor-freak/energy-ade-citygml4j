...
/**
 * <p>Java-Klasse für RegularTimeSeriesPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}RegularTimeSeries" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
public class RegularTimeSeriesPropertyType {
    ...
    @XmlElement(name = "RegularTimeSeries")
    ...
    /**
     * Ruft den Wert der regularTimeSeries-Eigenschaft ab.
     * 
     * @return
     *     possible object is
    ...
    /**
     * Legt den Wert der regularTimeSeries-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link RegularTimeSeriesType }
