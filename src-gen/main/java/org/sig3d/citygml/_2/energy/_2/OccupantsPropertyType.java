...
/**
 * <p>Java-Klasse für OccupantsPropertyType complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{http://www.sig3d.org/citygml/2.0/energy/2.0}Occupants" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
...
@XmlType(name = "OccupantsPropertyType", propOrder = {
    "occupants"
})
public class OccupantsPropertyType {

    @XmlElement(name = "Occupants")
    protected OccupantsType occupants;
    ...
    /**
     * Ruft den Wert der occupants-Eigenschaft ab.
     * 
     * @return
     *     possible object is
     *     {@link OccupantsType }
     *     
     */
    public OccupantsType getOccupants() {
        return occupants;
    }

    /**
     * Legt den Wert der occupants-Eigenschaft fest.
     * 
     * @param value
     *     allowed object is
     *     {@link OccupantsType }
     *     
     */
    public void setOccupants(OccupantsType value) {
